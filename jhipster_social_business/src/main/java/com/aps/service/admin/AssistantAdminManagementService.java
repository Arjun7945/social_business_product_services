...
public class AssistantAdminManagementService {
    ...
    public void showAssistantAdminMenu(TeamMember admin) {
        ...
        List<WhatsAppMessageDto.ButtonDto> buttons = com.aps.service.util.AssistantAdminMenuHelper
                .getAssistantAdminMenuButtons();
    ...
    public void finalizeAssistantAdminAdd(TeamMember admin, BotSession session) {
        ...
        try {
            ...
            org.slf4j.LoggerFactory.getLogger(AssistantAdminManagementService.class)
                    .error("Error adding assistant admin", e);
            whatsAppService.sendSimpleText(admin.getWaPhoneNumber(),
