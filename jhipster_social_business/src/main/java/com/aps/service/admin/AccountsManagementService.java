...
public class AccountsManagementService {
        ...
        public AccountsManagementService(TeamMemberRepository teamMemberRepository,
        ...
        public void showAllAccountsMembers(TeamMember admin) {
                List<TeamMember> members = teamMemberRepository.findAll().stream()
                                .filter(tm -> tm.getRole() == UserRole.ACCOUNTS_TEAM)
                                .toList();
                ...
                for (TeamMember member : members) {
                        message.append(String.format("%d. *%s*\n   📞 %s\n   📱 %s\n   🔄 %s\n\n",
                                        count++, member.getName(), member.getPhoneNumber(), member.getWaPhoneNumber(),
