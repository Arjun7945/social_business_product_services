...
public class ProductManagementService {
    ...
    public void showProductMenu(TeamMember admin) {
        List<WhatsAppMessageDto.ButtonDto> buttons = List.of(
            ...
            WhatsAppMessageDto.ButtonDto.builder()
                .type("reply")
                .reply(WhatsAppMessageDto.ReplyDto.builder().id("SHOW_ALL_PRODUCTS").title("📋 Show All").build())
                .build(),
            WhatsAppMessageDto.ButtonDto.builder()
                .type("reply")
        ...
        whatsAppService.sendCartActionButtons(admin.getWaPhoneNumber(), "🐟 *Product Management*\n\nWhat would you like to do?", buttons);
    ...
    public void startAddProduct(TeamMember admin, BotSession session) {
        ...
        whatsAppService.sendSimpleText(admin.getWaPhoneNumber(), "➕ *Add New Product*\n\n📝 Please provide the product name:");
    ...
    public void handleProductPriceInput(TeamMember admin, BotSession session, String price) {
        try {
            ...
            if (priceValue <= 0) {
                whatsAppService.sendSimpleText(admin.getWaPhoneNumber(), "❌ Price must be greater than zero. Try again:");
                return;
            }
    ...
    public void handleProductDescriptionInput(TeamMember admin, BotSession session, String description) {
        ...
        whatsAppService.sendCartActionButtons(admin.getWaPhoneNumber(), "✅ Description saved\n\n🔄 Is this product available?", buttons);
    ...
    public void handleProductAvailabilityInput(TeamMember admin, BotSession session, String availability) {
        boolean isAvailable =
            availability.trim().equalsIgnoreCase(FlowConstants.CMD_YES) || availability.trim().equalsIgnoreCase(FlowConstants.CMD_Y);
        ...
        if (message.getType().equals("image") && message.getImage() != null) {
            ...
            try {
                ...
                if (!currentMediaIds.isEmpty()) {
                    ...
                    whatsAppService.sendSimpleText(admin.getWaPhoneNumber(), "✅ Image received! Finalizing product... please wait.");
