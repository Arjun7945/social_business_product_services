...
/**
 * Criteria class for the {@link com.aps.domain.ShoppingCart} entity. This class is used
 * in {@link com.aps.web.rest.ShoppingCartResource} to receive all the possible filtering options from
...
public class ShoppingCartCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, createdAt, updatedAt, itemsId, customerId, distinct);
    }
