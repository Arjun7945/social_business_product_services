...
public class CustomerMessageService {
    ...
    public String getCustomerWelcomeByExecutive(String customerName, String customerPhone, String executiveName,
    ...
    public String getMessageCreditPrivilegesGranted(String customerName) {
        return String.format(
                "🎉 *അഭിനന്ദനങ്ങൾ, %s!* 🌟\n\n" +
                        "✅ നിങ്ങൾ ഇപ്പോൾ ഒരു **ക്രെഡിറ്റ് കസ്റ്റമർ** ആയി മാറിയിരിക്കുന്നു. 🙏\n\n" +
