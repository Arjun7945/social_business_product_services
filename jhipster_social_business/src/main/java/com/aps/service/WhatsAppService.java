...
public class WhatsAppService {
        ...
        public boolean sendDocument(String toWaId, String mediaId, String filename, String caption) {
                WhatsAppMessageDto message = WhatsAppMessageDto.builder()
                                .to(toWaId)
                                .type("document")
                                .document(WhatsAppMessageDto.DocumentDto.builder().id(mediaId).filename(filename)
                                                .caption(caption)
                                                .build())
                                .build();
        ...
        public boolean sendLocation(String toWaId, double lat, double lon, String name, String address) {
                WhatsAppMessageDto message = WhatsAppMessageDto.builder()
                                .to(toWaId)
                                .type("location")
                                .location(WhatsAppMessageDto.LocationDto.builder().latitude(lat).longitude(lon)
                                                .name(name)
                                                ...
                                                WhatsAppMessageDto.InteractiveDto.builder()
                                                                ...
                                                                .action(
                                                                                WhatsAppMessageDto.ActionDto.builder()
                                                                                                .buttons(
                                                                                                                List.of(
                                                                                                                                WhatsAppMessageDto.ButtonDto
                                                                                                                                                .builder()
                                                                                                                                                .type("reply")
                                                                                                                                                .reply(
                                                                                                                                                                WhatsAppMessageDto.ReplyDto
                                                                                                                                                                                .builder()
                                                                                                                                                                                .id("DELIVERY_TAKE_"
                                                                                                                                                                                                + orderId)
        ...
        public boolean sendInteractiveList(String toWaId, String bodyText, String buttonText,
                ...
                return sendInteractiveList(toWaId, bodyText, buttonText, messageService.getSectionTitleAvailableFish(),
                                rows);
        }

        public boolean sendInteractiveList(String toWaId, String bodyText, String buttonText, String sectionTitle,
                        List<WhatsAppMessageDto.RowDto> rows) {
                WhatsAppMessageDto message = WhatsAppMessageDto.builder()
                                .to(toWaId)
                                .type("interactive")
        ...
        public boolean sendInteractiveButtons(String toWaId, String bodyText,
