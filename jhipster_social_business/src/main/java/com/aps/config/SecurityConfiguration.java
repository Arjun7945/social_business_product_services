...
import com.aps.security.*;
import com.aps.web.filter.SpaWebFilter;
        ...
        public SecurityFilterChain filterChain(HttpSecurity http, MvcRequestMatcher.Builder mvc) throws Exception {
                http
                                ...
                                authz
                                                ...
                                                .requestMatchers(mvc.pattern("/api/webhooks/**")).permitAll()
                                                .requestMatchers(mvc.pattern("/api/product-images/public/**"))
                                                .permitAll()
                                                .requestMatchers(mvc.pattern(HttpMethod.GET, "/api/customers"))
                                                .permitAll() // Allowed for login check
                                                .requestMatchers(mvc.pattern("/api/otp/**")).permitAll() // Allowed for
                                                                                                         // OTP flow
