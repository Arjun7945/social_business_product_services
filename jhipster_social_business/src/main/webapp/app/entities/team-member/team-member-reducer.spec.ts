...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_TEAMMEMBER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_TEAMMEMBER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_TEAMMEMBER actions', async () => {
      const arg = { id: 22246 };
    ...
    it('dispatches UPDATE_TEAMMEMBER actions', async () => {
      const arg = { id: 22246 };
    ...
    it('dispatches PARTIAL_UPDATE_TEAMMEMBER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_TEAMMEMBER actions', async () => {
      const arg = 42666;
