...
import reducer, {
  ...
  reset,
  updateEntity,
} from './return-status-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RETURNSTATUSHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RETURNSTATUSHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RETURNSTATUSHISTORY actions', async () => {
      const arg = { id: 4716 };
    ...
    it('dispatches UPDATE_RETURNSTATUSHISTORY actions', async () => {
      const arg = { id: 4716 };
    ...
    it('dispatches PARTIAL_UPDATE_RETURNSTATUSHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RETURNSTATUSHISTORY actions', async () => {
      const arg = 42666;
