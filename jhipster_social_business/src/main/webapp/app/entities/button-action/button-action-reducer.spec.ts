...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BUTTONACTION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BUTTONACTION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BUTTONACTION actions', async () => {
      const arg = { id: 25029 };
    ...
    it('dispatches UPDATE_BUTTONACTION actions', async () => {
      const arg = { id: 25029 };
    ...
    it('dispatches PARTIAL_UPDATE_BUTTONACTION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BUTTONACTION actions', async () => {
      const arg = 42666;
