...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMOVEDUSER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REMOVEDUSER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REMOVEDUSER actions', async () => {
      const arg = { id: 8535 };
    ...
    it('dispatches UPDATE_REMOVEDUSER actions', async () => {
      const arg = { id: 8535 };
    ...
    it('dispatches PARTIAL_UPDATE_REMOVEDUSER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REMOVEDUSER actions', async () => {
      const arg = 42666;
