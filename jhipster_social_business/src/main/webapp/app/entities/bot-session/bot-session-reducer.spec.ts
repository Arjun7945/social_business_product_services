...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BOTSESSION_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_BOTSESSION actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_BOTSESSION actions', async () => {
      const arg = { id: 26689 };
    ...
    it('dispatches UPDATE_BOTSESSION actions', async () => {
      const arg = { id: 26689 };
    ...
    it('dispatches PARTIAL_UPDATE_BOTSESSION actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_BOTSESSION actions', async () => {
      const arg = 42666;
