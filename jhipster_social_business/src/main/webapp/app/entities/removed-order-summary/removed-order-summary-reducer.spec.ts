...
import reducer, {
  ...
  reset,
  updateEntity,
} from './removed-order-summary.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_REMOVEDORDERSUMMARY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_REMOVEDORDERSUMMARY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_REMOVEDORDERSUMMARY actions', async () => {
      const arg = { id: 16037 };
    ...
    it('dispatches UPDATE_REMOVEDORDERSUMMARY actions', async () => {
      const arg = { id: 16037 };
    ...
    it('dispatches PARTIAL_UPDATE_REMOVEDORDERSUMMARY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_REMOVEDORDERSUMMARY actions', async () => {
      const arg = 42666;
