...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMERORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMERORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMERORDER actions', async () => {
      const arg = { id: 9643 };
    ...
    it('dispatches UPDATE_CUSTOMERORDER actions', async () => {
      const arg = { id: 9643 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMERORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMERORDER actions', async () => {
      const arg = 42666;
