...
export const CustomerDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="whatsappProductServiceProApp.customer.delete.question">
        <Translate contentKey="whatsappProductServiceProApp.customer.delete.question" interpolate={{ id: customerEntity.id }}>
