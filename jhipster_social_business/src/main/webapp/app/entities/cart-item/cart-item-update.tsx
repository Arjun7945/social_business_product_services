...
export const CartItemUpdate = () => {
  ...
  const saveEntity = values => {
    ...
    if (values.quantityKg !== undefined && typeof values.quantityKg !== 'number') {
      values.quantityKg = Number(values.quantityKg);
    }
  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="whatsappProductServiceProApp.cartItem.home.createOrEditLabel" data-cy="CartItemCreateUpdateHeading">
            <Translate contentKey="whatsappProductServiceProApp.cartItem.home.createOrEditLabel">Create or edit a CartItem</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('whatsappProductServiceProApp.cartItem.quantityKg')}
                id="cart-item-quantityKg"
                name="quantityKg"
                data-cy="quantityKg"
                type="text"
                validate={{
              ...
              />
              <ValidatedField
                label={translate('whatsappProductServiceProApp.cartItem.addedAt')}
              ...
              <ValidatedField
                ...
                name="product"
                data-cy="product"
                label={translate('whatsappProductServiceProApp.cartItem.product')}
                type="select"
                required
              >
                <option value="" key="0" />
              ...
              <ValidatedField
                ...
                name="cart"
                data-cy="cart"
                label={translate('whatsappProductServiceProApp.cartItem.cart')}
                type="select"
                required
              >
                <option value="" key="0" />
