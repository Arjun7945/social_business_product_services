...
export const CartItemDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="whatsappProductServiceProApp.cartItem.delete.question">
        <Translate contentKey="whatsappProductServiceProApp.cartItem.delete.question" interpolate={{ id: cartItemEntity.id }}>
