...
export const DeliveryPersonDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="whatsappProductServiceProApp.deliveryPerson.delete.question">
        <Translate contentKey="whatsappProductServiceProApp.deliveryPerson.delete.question" interpolate={{ id: deliveryPersonEntity.id }}>
