...
import reducer, {
  ...
  reset,
  updateEntity,
} from './order-status-history.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ORDERSTATUSHISTORY_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_ORDERSTATUSHISTORY actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_ORDERSTATUSHISTORY actions', async () => {
      const arg = { id: 8807 };
    ...
    it('dispatches UPDATE_ORDERSTATUSHISTORY actions', async () => {
      const arg = { id: 8807 };
    ...
    it('dispatches PARTIAL_UPDATE_ORDERSTATUSHISTORY actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_ORDERSTATUSHISTORY actions', async () => {
      const arg = 42666;
