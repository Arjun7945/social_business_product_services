  ...
  return (
    <div>
      <h2 id="product-image-heading" data-cy="ProductImageHeading">
        <Translate contentKey="whatsappProductServiceProApp.productImage.home.title">Product Images</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="whatsappProductServiceProApp.productImage.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/product-image/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="whatsappProductServiceProApp.productImage.home.createLabel">Create new Product Image</Translate>
          </Link>
        </div>
      </h2>
        ...
        {productImageList && productImageList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="whatsappProductServiceProApp.productImage.id">ID</Translate>{' '}
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="whatsappProductServiceProApp.productImage.home.notFound">No Product Images found</Translate>
            </div>
          )
        )}
      </div>
