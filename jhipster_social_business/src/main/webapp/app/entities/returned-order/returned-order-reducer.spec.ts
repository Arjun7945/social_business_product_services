...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RETURNEDORDER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RETURNEDORDER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RETURNEDORDER actions', async () => {
      const arg = { id: 4321 };
    ...
    it('dispatches UPDATE_RETURNEDORDER actions', async () => {
      const arg = { id: 4321 };
    ...
    it('dispatches PARTIAL_UPDATE_RETURNEDORDER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RETURNEDORDER actions', async () => {
      const arg = 42666;
