...
export const OrderItemDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="whatsappProductServiceProApp.orderItem.delete.question">
        <Translate contentKey="whatsappProductServiceProApp.orderItem.delete.question" interpolate={{ id: orderItemEntity.id }}>
