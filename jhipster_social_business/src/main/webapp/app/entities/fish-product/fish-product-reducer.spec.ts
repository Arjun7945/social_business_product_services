...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_FISHPRODUCT_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_FISHPRODUCT actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_FISHPRODUCT actions', async () => {
      const arg = { id: 15405 };
    ...
    it('dispatches UPDATE_FISHPRODUCT actions', async () => {
      const arg = { id: 15405 };
    ...
    it('dispatches PARTIAL_UPDATE_FISHPRODUCT actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_FISHPRODUCT actions', async () => {
      const arg = 42666;
