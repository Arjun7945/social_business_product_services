...
import reducer, {
  ...
  reset,
  updateEntity,
} from './returned-order-item.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RETURNEDORDERITEM_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_RETURNEDORDERITEM actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_RETURNEDORDERITEM actions', async () => {
      const arg = { id: 2994 };
    ...
    it('dispatches UPDATE_RETURNEDORDERITEM actions', async () => {
      const arg = { id: 2994 };
    ...
    it('dispatches PARTIAL_UPDATE_RETURNEDORDERITEM actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_RETURNEDORDERITEM actions', async () => {
      const arg = 42666;
