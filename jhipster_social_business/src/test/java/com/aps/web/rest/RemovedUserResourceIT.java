...
class RemovedUserResourceIT {
    ...
    void createRemovedUser() throws Exception {
        ...
        var returnedRemovedUserDTO = om.readValue(
            restRemovedUserMockMvc
                .perform(post(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(removedUserDTO)))
    ...
    void getAllRemovedUsersByOriginalIdIsEqualToSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("originalId.equals=" + DEFAULT_ORIGINAL_ID, "originalId.equals=" + UPDATED_ORIGINAL_ID);
    }
    ...
    void getAllRemovedUsersByOriginalIdIsLessThanSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("originalId.lessThan=" + UPDATED_ORIGINAL_ID, "originalId.lessThan=" + DEFAULT_ORIGINAL_ID);
    }
    ...
    void getAllRemovedUsersByOriginalIdIsGreaterThanSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("originalId.greaterThan=" + SMALLER_ORIGINAL_ID, "originalId.greaterThan=" + DEFAULT_ORIGINAL_ID);
    }
    ...
    void getAllRemovedUsersByWhatsappNumberIsEqualToSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("whatsappNumber.equals=" + DEFAULT_WHATSAPP_NUMBER, "whatsappNumber.equals=" + UPDATED_WHATSAPP_NUMBER);
    }
    ...
    void getAllRemovedUsersByPhoneNumberIsEqualToSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("phoneNumber.equals=" + DEFAULT_PHONE_NUMBER, "phoneNumber.equals=" + UPDATED_PHONE_NUMBER);
    }
    ...
    void getAllRemovedUsersByPhoneNumberContainsSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("phoneNumber.contains=" + DEFAULT_PHONE_NUMBER, "phoneNumber.contains=" + UPDATED_PHONE_NUMBER);
    }
    ...
    void getAllRemovedUsersByAddressIsInShouldWork() throws Exception {
        ...
        defaultRemovedUserFiltering("address.in=" + DEFAULT_ADDRESS + "," + UPDATED_ADDRESS, "address.in=" + UPDATED_ADDRESS);
    }
    ...
    void getAllRemovedUsersByAddressNotContainsSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("address.doesNotContain=" + UPDATED_ADDRESS, "address.doesNotContain=" + DEFAULT_ADDRESS);
    }
    ...
    void getAllRemovedUsersByLocationLatIsEqualToSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("locationLat.equals=" + DEFAULT_LOCATION_LAT, "locationLat.equals=" + UPDATED_LOCATION_LAT);
    }
    ...
    void getAllRemovedUsersByLocationLatIsLessThanSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("locationLat.lessThan=" + UPDATED_LOCATION_LAT, "locationLat.lessThan=" + DEFAULT_LOCATION_LAT);
    }
    ...
    void getAllRemovedUsersByLocationLatIsGreaterThanSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("locationLat.greaterThan=" + SMALLER_LOCATION_LAT, "locationLat.greaterThan=" + DEFAULT_LOCATION_LAT);
    }
    ...
    void getAllRemovedUsersByLocationLonIsEqualToSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("locationLon.equals=" + DEFAULT_LOCATION_LON, "locationLon.equals=" + UPDATED_LOCATION_LON);
    }
    ...
    void getAllRemovedUsersByLocationLonIsLessThanSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("locationLon.lessThan=" + UPDATED_LOCATION_LON, "locationLon.lessThan=" + DEFAULT_LOCATION_LON);
    }
    ...
    void getAllRemovedUsersByLocationLonIsGreaterThanSomething() throws Exception {
        ...
        defaultRemovedUserFiltering("locationLon.greaterThan=" + SMALLER_LOCATION_LON, "locationLon.greaterThan=" + DEFAULT_LOCATION_LON);
    }
    ...
    void getAllRemovedUsersByJoinedAtIsInShouldWork() throws Exception {
        ...
        defaultRemovedUserFiltering("joinedAt.in=" + DEFAULT_JOINED_AT + "," + UPDATED_JOINED_AT, "joinedAt.in=" + UPDATED_JOINED_AT);
    }
    ...
    void getAllRemovedUsersByRemovedAtIsInShouldWork() throws Exception {
        ...
        defaultRemovedUserFiltering("removedAt.in=" + DEFAULT_REMOVED_AT + "," + UPDATED_REMOVED_AT, "removedAt.in=" + UPDATED_REMOVED_AT);
    }
    ...
    void getAllRemovedUsersByStatusIsInShouldWork() throws Exception {
        ...
        defaultRemovedUserFiltering("status.in=" + DEFAULT_STATUS + "," + UPDATED_STATUS, "status.in=" + UPDATED_STATUS);
    }
    ...
    void getAllRemovedUsersByDistanceFromBusinessKmIsGreaterThanOrEqualToSomething() throws Exception {
        ...
        // Get all the removedUserList where distanceFromBusinessKm is greater than or equal to
        defaultRemovedUserFiltering(
    ...
    void getAllRemovedUsersByDistanceFromBusinessKmIsLessThanOrEqualToSomething() throws Exception {
        ...
        // Get all the removedUserList where distanceFromBusinessKm is less than or equal to
        defaultRemovedUserFiltering(
    ...
    void putExistingRemovedUser() throws Exception {
        ...
        // Disconnect from session so that the updates on updatedRemovedUser are not directly saved in db
    ...
    void putWithMissingIdPathParamRemovedUser() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restRemovedUserMockMvc
            .perform(put(ENTITY_API_URL).contentType(MediaType.APPLICATION_JSON).content(om.writeValueAsBytes(removedUserDTO)))
    ...
    void fullUpdateRemovedUserWithPatch() throws Exception {
        ...
        assertSameRepositoryCount(databaseSizeBeforeUpdate);
        assertRemovedUserUpdatableFieldsEquals(partialUpdatedRemovedUser, getPersistedRemovedUser(partialUpdatedRemovedUser));
    }
    ...
    void patchWithMissingIdPathParamRemovedUser() throws Exception {
        ...
        // If url ID doesn't match entity ID, it will throw BadRequestAlertException
        restRemovedUserMockMvc
            .perform(patch(ENTITY_API_URL).contentType("application/merge-patch+json").content(om.writeValueAsBytes(removedUserDTO)))
            .andExpect(status().isMethodNotAllowed());
    ...
    protected void assertPersistedRemovedUserToMatchUpdatableProperties(RemovedUser expectedRemovedUser) {
        assertRemovedUserAllUpdatablePropertiesEquals(expectedRemovedUser, getPersistedRemovedUser(expectedRemovedUser));
    }
}
