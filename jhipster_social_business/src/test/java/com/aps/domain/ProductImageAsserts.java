...
public class ProductImageAsserts {
    ...
    public static void assertProductImageUpdatableFieldsEquals(ProductImage expected, ProductImage actual) {
        assertThat(expected)
                ...
                // .satisfies(e -> assertThat(e.getImageUrl()).as("check
                // imageUrl").isEqualTo(actual.getImageUrl()))
                .satisfies(e -> assertThat(e.getDisplayOrder()).as("check displayOrder")
                        .isEqualTo(actual.getDisplayOrder()));
    }
