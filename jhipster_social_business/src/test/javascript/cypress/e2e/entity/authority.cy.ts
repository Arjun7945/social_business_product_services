...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: '936e71d5-35bb-4aa4-85ce-482a553dea3e' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('33d91940-62c6-4aee-8fe4-7cc17b90e84a');
      cy.get(`[data-cy="name"]`).should('have.value', '33d91940-62c6-4aee-8fe4-7cc17b90e84a');
